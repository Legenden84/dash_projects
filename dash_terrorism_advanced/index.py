...
# Creating dataframe
terr2 = pd.read_csv(
    'https://raw.githubusercontent.com/Mubeen31/Global-Terrorism-Database-in-plotly-dash/main/modified_globalterrorismdb_0718dist.csv')
...
def update_graph(w_countries, w_countries1, select_years):
    ...
    terr6 = terr5[(terr5['region_txt'] == w_countries) & (terr5['country_txt'] == w_countries1) & (
    ...
    terr8 = terr7[(terr7['region_txt'] == w_countries) & (terr7['country_txt'] == w_countries1) & (
                terr7['iyear'] >= select_years[0]) & (terr7['iyear'] <= select_years[1])]
